...
export const workersData: Worker[] = [
  ...
  skills: [
    { id: "skill-1", workerId: "wrk-102", name: "Béton armé" },
    { id: "skill-2", workerId: "wrk-102", name: "Coffrage" },
    { id: "skill-3", workerId: "wrk-102", name: "Fondations" },
  ],
  images: [], // tu peux ajouter tes images ici si besoin
...
},
{
  ...
  skills: [
    { id: "skill-1", workerId: "wrk-103", name: "Briques" },
    { id: "skill-2", workerId: "wrk-103", name: "Pierre" },
    { id: "skill-3", workerId: "wrk-103", name: "Ciment" },
  ],
  images: [], // ajouter tes images si besoin
...
},
{
  ...
  image: "/assets/workers/contruction-worker-2119866.webp",
  skills: [
    { id: "skill-1", workerId: "wrk-104", name: "Coffrage" },
    { id: "skill-2", workerId: "wrk-104", name: "Béton" },
    { id: "skill-3", workerId: "wrk-104", name: "Réparation" },
  ],
  images: [], // ajouter tes images si besoin
...
},
{
  ...
  skills: [
    { id: "skill-1", workerId: "wrk-105", name: "Maçonnerie légère" },
    { id: "skill-2", workerId: "wrk-105", name: "Enduits" },
    { id: "skill-3", workerId: "wrk-105", name: "Rénovation" },
  ],
  images: [], // ajouter tes images si besoin
...
},
{
  ...
  image: "/assets/workers/bouwer-3430239.webp",
  skills: [
    { id: "skill-1", workerId: "wrk-201", name: "Menuiserie bois" },
    { id: "skill-2", workerId: "wrk-201", name: "Agencement" },
...
},
{
  ...
  image: "/assets/workers/builder-13483484.webp",
  skills: [
    { id: "skill-1", workerId: "wrk-202", name: "Fabrication de meubles" },
    { id: "skill-2", workerId: "wrk-202", name: "Découpe" },
    { id: "skill-3", workerId: "wrk-202", name: "Vernis" },
  ],
  images: [], // ajouter des images si besoin
